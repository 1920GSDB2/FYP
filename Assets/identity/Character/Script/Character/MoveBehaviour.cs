...
public class MoveBehaviour : GenericBehaviour
{
	...
	public float jumpHeight = 2f;                   // Default jump height.
	public float jumpIntertialForce = 7f;           // Default horizontal inertial force when jumping.
    public float stepSound = 10f;                    // How loud is the sound that generated by move
	...
	{
		// Get jump input.
		if (!jump && Input.GetKey(KeyCode.Space) && behaviourManager.IsCurrentBehaviour(behaviourCode) && !behaviourManager.IsOverriding())
			jump = true;
	}
	...
	void JumpManagement()
	{
		...
		else if (behaviourManager.GetAnim.GetBool(jumpBool))
		{
			...
			if (!behaviourManager.IsGrounded() && !isColliding && behaviourManager.GetTempLockStatus())
				behaviourManager.GetRigidBody.AddForce(transform.forward * jumpIntertialForce * Physics.gravity.magnitude * speed * 2, ForceMode.Acceleration);
            ...
            if ((behaviourManager.GetRigidBody.velocity.y < 0) && behaviourManager.IsGrounded())
			{
				behaviourManager.GetAnim.SetBool(groundedBool, true);
                EndJump();
                speed -= Mathf.Clamp(speed - 0.6f, 0, 2f);
