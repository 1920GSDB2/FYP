...
namespace TFT
{
    ...
    public class Buff : MonoBehaviour
    {
        ...
        {
            BuffList.Instance.BuffDetailPanel.SetActive(true);
            BuffList.Instance.BuffDetailText.text = BuffDetail;
        }

        public void OffBuffDetail()
        {
            BuffList.Instance.BuffDetailPanel.SetActive(false);
        }
